...
Our `Content Delivery Network (CDN) <https://en.wikipedia.org/wiki/Content_delivery_network>`_ subdomain is `https://cdn.api.acme.codes <https://cdn.api.acme.codes>`_ and our current `global cloud provider <https://en.wikipedia.org/wiki/Cloud_computing>`_ for our CDN is `Microsoft Azure <https://azure.microsoft.com>`_. Support for using ACME's `CDN <https://acme.readthedocs.io/en/latest/CDN.html>`_ is limited to paying subscribers.
