...
ACME's service at https://api.acme.codes provides near real time creation of customized animations of any scannable code, including QR codes. Standard codes and QR codes (non-animated) can also be created, and are free of charge within certain volume limitations.
